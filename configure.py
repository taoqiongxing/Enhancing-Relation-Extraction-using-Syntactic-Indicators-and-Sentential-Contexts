...
def parse_args():
    ...
    # Embeddings
    parser.add_argument("--embeddings", default='bert', #None,
                        type=str, help="Embeddings {'bert'，'word2vec', 'glove100', 'glove300', 'elmo'}")
    parser.add_argument("--embedding_size", default=1024,
                        type=int, help="Dimensionality of word embedding (default: 300)")
    parser.add_argument("--pos_embedding_size", default=250,
    ...
    # RNN
    parser.add_argument("--hidden_size", default=256,#1024,
    ...
    parser.add_argument("--attention_size", default=250,
